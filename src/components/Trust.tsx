      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center space-x-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-sm font-semibold">Trusted by Students & Parents</span>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-16">
          {trustFactors.map((factor, index) => {
            ...
            return (
              ...
              >
                <div className="inline-flex p-5 rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 group-hover:from-blue-100 group-hover:to-cyan-100 mb-4 transition-colors duration-300">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 sm:p-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              {commitments.map((commitment, index) => (
                <div
                  key={index}
                  className="flex items-start space-x-3 bg-white rounded-xl p-4 hover:shadow-md transition-shadow duration-300"
                >
            ...
            <div className="mt-12 text-center">
              <div className="inline-flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-8 bg-white rounded-2xl p-6 shadow-sm">
